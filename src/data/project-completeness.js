...
// Мʼякі прохання для прогалин: тап на «уточнити: …» → це йде в чат як прохання
// юзера, OWL (експерт) допомагає закрити саме цей вимір. Не форма — розмова.
export const PROJECT_GAP_PROMPTS = {
