...
function _getInboxBoardContext() {
  ...
  Чіп 1: action='complete', payload={"task_id":${t.id}}, label = підтвердження виконання у минулому часі + ✔️ під контекст задачі (для «Зареєструватися на Upwork» → «Вже зареєструвався ✔️», для «Подати декларацію» → «Подав ✔️», для «Купити продукти» → «Купив ✔️»).
