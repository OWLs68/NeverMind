...
- 💰 FAST-PATH FINANCE (LfA6w 07.05): «ЧИСЛО + ПОВСЯКДЕННИЙ ТОВАР/ПОСЛУГА» («80 бензин», «50 кава», «200 продукти», «25 таксі», «800 оренда», «150 ліки», «60 обід», «300 інтернет», «500 телефон», «90 хліб», «120 паркінг») → ВИКЛИКАЙ save_finance НАПРЯМУ як expense. БЕЗ чіпів, БЕЗ уточнень. Категорія за іменником: бензин/таксі/паркінг/проїзд→Транспорт, кава/обід/їжа/продукти/хліб/молоко→Їжа, ліки/аптека/лікар→Здоров'я, оренда/комуналка/інтернет→Житло, телефон/підписка→Підписки, одяг/взуття→Покупки. Якщо неясно — Інше. Ці категорії — ВИТРАТА на 95%+, не питай.
