...
export async function sendTasksBarMessage() {
  ...
  const systemPrompt = getOWLPersonality() + '\n\n'
    ...
    + '🔴 ЖОРСТКЕ ПРАВИЛО ЗВИЧОК: ПЕРЕВІР список "ЗВИЧКИ СЬОГОДНІ" вище. Якщо назви що просить юзер ТАМ НЕМА — викликай save_habit (нова звичка). Якщо ТОЧНО Є з ID — edit_habit. НЕ кажи "у тебе вже є звичка X" якщо X не у списку. НЕ галюцинуй звички.\n'
