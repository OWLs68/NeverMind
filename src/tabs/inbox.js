...
// === СТРІЧКА INBOX — ПЕРЕНЕСЕНО (v3pexs 28.06, D2) ===
// Дані+рендер стрічки (314 рядків) → src/tabs/inbox-feed.js. Ре-експорт
// (strangler): 7 імпортерів getInbox/saveInbox/renderInbox без змін.
import { getInbox, saveInbox, renderInbox, navigateInboxItem } from './inbox-feed.js';
export { getInbox, saveInbox, renderInbox } from './inbox-feed.js';
