...
//
// ⚠️ АРХІВОВАНО v1d9eo — НЕ імпортується (app.js закоментовано). Голосовий режим
// (TTS-озвучка відповідей OWL + зелена кнопка у шапці) відкладено за рішенням
// Романа: на iOS-вебі ненадійно. Лишився лише нижній мік (voice-input) для
// диктування тексту. Повернеться у великій збірці голосу-конвеєра після Supabase
// (план → docs/VOICE_REALTIME_PLAN.md). Файл збережено для тієї збірки.
//
