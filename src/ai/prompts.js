...
export const INBOX_TOOLS = [
  ...
  { type: "function", function: { name: "update_transaction", description: "Змінити існуючу фінансову операцію. Юзер ЯВНО каже змінити/виправити суму або категорію.", parameters: { type: "object", properties: { _reasoning_log: { type: "string", description: "CoT — 1-2 речення українською. ОБОВʼЯЗКОВО (див. REASONING_LOG_RULE)." }, id: { type: "string", description: "UUID транзакції з контексту" }, category: { type: "string" }, amount: { type: "number" }, comment: { type: "string" } }, required: ["_reasoning_log","id"], additionalProperties: false } } },
  ...
  { type: "function", function: { name: "delete_medication", description: "Видалити препарат з картки Здоров'я. Юзер каже 'прибери Парацетамол', 'закінчив курс X', 'видали препарат Y'. Можна повернути через restore_deleted якщо помилково.", parameters: { type: "object", properties: { _reasoning_log: { type: "string", description: "CoT — 1-2 речення українською. ОБОВʼЯЗКОВО (див. REASONING_LOG_RULE)." }, card_id: { type: "string", description: "UUID картки з контексту (формат [ID:xxxx-xxxx]). НЕ вигадуй — копіюй точно." }, med_id: { type: "string", description: "UUID препарату з контексту картки (формат [ID:xxxx-xxxx] у списку ліки). НЕ вигадуй — копіюй точно." }, comment: { type: "string" } }, required: ["_reasoning_log","card_id", "med_id", "comment"], additionalProperties: false } } },
