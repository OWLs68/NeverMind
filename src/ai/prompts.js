...
ЯКЩО повідомлення описує дію яку треба виконати у майбутньому (дієслово в інфінітиві -ти/-ть АБО наказовий спосіб АБО короткий TODO-стиль) — у будь-якій позиції речення → save_task.
Покладайся на свою граматику — ти знаєш українську мову.
...
ВИНЯТКИ — НЕ задача:
  • Минулий час («купив», «помив», «зробив») → КРОК 5.
