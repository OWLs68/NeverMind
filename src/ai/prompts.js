...
- "нагадай ..." БЕЗ часу (MPVly 05.05 fix — конфлікт з REMINDER_RULES) → ОБОВ'ЯЗКОВО пиши "Коли нагадати?" + 4 чіпи `{"chips":[...]}`, навіть якщо запит ≤5 слів. Інакше падає у saveOffline → ✓ Збережено як нотатка → юзер втрачає reminder. Див. REMINDER_RULES — пріоритет вище за тиху відповідь.
