...
- 🚨 КОРИГУВАННЯ ЧАСУ (B-126 fix MPVly 05.05): якщо юзер коригує час свіжого нагадування ("не на 10 а на 9", "не давай на 9", "насправді в 09:30", "ні, на 8", "переніс на 11") і у цьому ж чаті щойно був set_reminder — ОБОВ'ЯЗКОВО спочатку виклич delete_reminder зі СТАРИМ часом, ПОТІМ set_reminder з новим. Інакше створиш дубль (старий лишиться у Розпорядку). Приклад: щойно set_reminder(text="Помити посуд", time="10:00") → юзер каже "не на 10 а на 9" → 1) delete_reminder(text="Помити посуд", time="10:00") 2) set_reminder(text="Помити посуд", time="09:00").`;
