...
export const INBOX_TOOLS = [
  ...
  { type: "function", function: { name: "delete_event", description: "Видалити подію з календаря.", parameters: { type: "object", properties: { _reasoning_log: { type: "string", description: "CoT — 1-2 речення українською. ОБОВʼЯЗКОВО (див. REASONING_LOG_RULE)." }, event_id: { type: "string" }, comment: { type: "string" } }, required: ["_reasoning_log","event_id"], additionalProperties: false } } },
  ...
  { type: "function", function: { name: "delete_health_card", description: "Видалити картку Здоров'я (з кошика 7 днів). ВИКЛИКАТИ коли юзер прямо просить видалити стан.", parameters: { type: "object", properties: { _reasoning_log: { type: "string", description: "CoT — 1-2 речення українською. ОБОВʼЯЗКОВО (див. REASONING_LOG_RULE)." }, card_id: { type: "string" }, comment: { type: "string" } }, required: ["_reasoning_log","card_id", "comment"], additionalProperties: false } } },
