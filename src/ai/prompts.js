...
Формат питання: одне речення + 2-3 чіпи-відповіді для типових варіантів ("Сьогодні" / "Тиждень тому" / "Давно"). Не дотискай — якщо юзер проігнорував або дав іншу інфу, створи картку з тим що є.
