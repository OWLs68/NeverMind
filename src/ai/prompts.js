...
// ===== 2. INBOX_SYSTEM_PROMPT — класифікатор Inbox =====
...
// ===== 5. EVENING_CHAT_SYSTEM — діалог з совою у чат-барі Вечора (Фаза 4) =====
// Відрізняється від callOwlChat формату (CHIP_JSON_FORMAT): менше nav-чіпів,
// більше контекстних діалогових. Чіпи — варіанти ШВИДКОЇ ВІДПОВІДІ для ритуалу.
...
// ===== 6. getOwlChatSystemPrompt — OWL міні-чат =====
