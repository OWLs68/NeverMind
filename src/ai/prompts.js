...
ЯКЩО є дієслово в ІНФІНІТИВІ ("купити", "зателефонувати") АБО НАКАЗ ("купи", "зроби") АБО план «треба зробити» БЕЗ суми → save_task.

КРОК 7. ЗАПИС / ДУМКА / ІДЕЯ:
Усе інше що не підходить під 1-6 → save_note (думки, рефлексія) АБО save_moment (емоційний факт дня).
