...
ЯКЩО повідомлення містить суму:
  • Число + повсякденна послуга або товар (юзер явно назвав що це) → save_finance як expense. Без паралельного save_task.
  • Число + іменник (товар/послуга) → save_finance ОДНОЗНАЧНО, БЕЗ перепитувань. Юзер сам напише «купити X» якщо це задача. Принцип «легше навчити юзера ніж AI вгадувати».
  • Число + назва бізнесу/послуги-точки (хімчистка, салон, курс) → не викликай tools. content + 4 чіпи action='clarify_save' (Витрата / Створити проект / Задача / Не зберігати).
  • Голий іменник без числа ("Хімчистка") → не викликай tools. content + 3 чіпи action='clarify_save' (У щоденник / Як момент / Не зберігати).
Покладайся на здоровий глузд: повсякденні витрати очевидні, неоднозначне — питай чіпами.
