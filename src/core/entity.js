...
//    - id: зараз v4 (наявний generateUUID, ним уже згенеровані всі живі записи).
//      План згадує uuid v7 (час-сортований, кращий індекс) — перехід РАЗОМ із
//      Supabase, не зараз (інакше розрив формату на живих даних).
