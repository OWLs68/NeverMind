...
**Чому погано:** Роман отримує кашу яку не може прибрати. Юзер у MVP-стилі (швидко перевіряє нові фічі рукою) натикається на це **на першому реальному використанні**. Результат — повний відкат. Patтерн «менше > бардак» — критерій якості Романа, не побажання.
...
**Звʼязок з правилом 6 у CLAUDE.md:** smoke-test після **і** є фінальною перевіркою що cleanup працює рукою на iPhone. Cleanup в плані — це що тестуємо. Smoke-test — що дійсно тестуємо.
