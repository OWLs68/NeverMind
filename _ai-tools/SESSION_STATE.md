...
- Черга gfrvu5: лишилась фіча списків в Inbox (`save_list` + картка-чекліст, /byyou-розмір, рішення сутності на старті).
...
1. **Фіча списків в Inbox** — «склади список» → картка з квадратиками в Inbox (не Задача) + чіп «Задача/Список». /byyou-розмір. Рішення сутності — на брамі старту.
