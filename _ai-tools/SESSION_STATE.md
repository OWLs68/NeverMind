...
- B-11/B-12 — padding модалок зменшено (28px → 48px по боках), в main

## Наступне
- Дочекатись підтвердження що авто-оновлення працює
- Потім продовжити відкриті баги або нові фічі
