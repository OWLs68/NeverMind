...
### Метрики
Гілка `claude/new-session-26yz5s`. Коміти `ee2f0de`→`d731094` (~15). CACHE `nm-20260703-0105` (потік /byyou src/ не чіпав). Деплой v1110. Сторожів у CI: 16 node (+check-dnt-guard) + ESLint; нові workflow: canary.yml + ai-smoke.yml.
