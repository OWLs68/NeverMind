...
1. **🚨 iPhone-перевірка v472 — НЕ БОРГ, ПАТЕРН ПОВЕДІНКИ** (brain-фідбек lRnXU 29.04). 6 сесій підряд: kGX6g/UG1Fr/m4Q1o/oknnM/SK6E2/7PQ1a — Роман каже «тестую ввечері», не робить. Кожне таке «зроблю» що не виконується знецінює всі обіцянки в ROADMAP. **Дві опції на 30.04:** (а) РАНКОВА перевірка перед будь-якою новою сесією, (б) чесно зняти з обіцянок («перевірю при наступному релізі», «через тиждень»). Без вибору — патерн поглиблюється.
