...
_Зберігаються закриті у 2 останніх активних сесіях (WML2Z + RQmdC). Старіші (Ug2Jw + HKnlM + DGH6F + раніше) перенесено у [`_archive/BUGS_HISTORY.md`](_archive/BUGS_HISTORY.md). Ротація Ug2Jw виконана WML2Z 03.06 /finish._
