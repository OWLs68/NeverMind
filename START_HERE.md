...
| # | Файл | Що дає |
|---|------|--------|
| 1 | `CLAUDE.md` | Правила процесу, файлова структура, **Карта документації**. Технічні деталі (AI-логіка, Дані, Деплой) → `docs/TECHNICAL_REFERENCE.md`. Список AI tools → `docs/AI_TOOLS.md` |
