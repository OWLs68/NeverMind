...
### Передача сесії (якщо закінчились ліміти)

Коли користувач каже "ліміти закінчуються" або "треба передати сесію":

1. Запиши поточний стан в `_ai-tools/SESSION_HANDOFF.md`:

```markdown
# Передача сесії — [дата і час]

## Що робили
[задача яку виконували]

## Що зроблено
[список виконаних кроків з назвами файлів]

## Що залишилось
[конкретні наступні кроки]

## Важливий контекст
[рішення, нюанси, попередження які треба знати]

## Файли змінені в цій сесії
[список файлів]
```

2. Зроби git commit і push цього файлу
3. Скажи користувачу: "Сесію збережено. На новому акаунті напиши: *прочитай SESSION_HANDOFF.md і продовжуй*"

**На початку нової сесії:** якщо існує `_ai-tools/SESSION_HANDOFF.md` — прочитай його першим ділом і повідом користувача що підхопив контекст.
