...
- **Пояснення в дужках** — після будь-якого англомовного терміну, назви функції, команди чи технічного слова — завжди додавати пояснення або переклад українською в дужках. Наприклад: `hook` (хук — автоматична дія), `git push` (відправити зміни на сервер).
