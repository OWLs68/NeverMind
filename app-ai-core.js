...
- task: є конкретна НОВА дія яку треба зробити ("зателефонувати", "купити", "зробити", "відправити")
  ...
  ВИНЯТОК: якщо задача масштабна або довгострокова (ремонт квартири, запуск бізнесу, розробка продукту, великий проект) — це create_project, НЕ task
...
ЯКЩО користувач хоче створити ПРОЕКТ — відповідай ТІЛЬКИ JSON:
{
  "action": "create_project",
  "name": "коротка назва проекту (2-5 слів)",
  "subtitle": "підзаголовок або порожньо"
}
Проект — це масштабна або довгострокова ціль з кількома етапами. Тригери: "запустити", "побудувати", "розробити", "відкрити", "ремонт", "створити проект", "реалізувати", "організувати [щось велике]".
Приклади проектів: "ремонт квартири", "запустити онлайн-курс", "розробити додаток", "відкрити кафе", "організувати весілля".
Приклади задач (НЕ проектів): "зателефонувати в банк", "купити ліки", "написати email".
