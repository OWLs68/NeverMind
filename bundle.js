  ...
  function _tryLocalFallback(tab) {
    ...
    try {
      ...
      if (tasks.length > 0 && pendingH.length > 0) {
        text = mode === "coach" ? `\u0404 ${tasks.length} \u0437\u0430\u0434\u0430\u0447 \u0456 ${pendingH.length} \u0437\u0432\u0438\u0447\u043E\u043A. \u0414\u0430\u0432\u0430\u0439 \u0445\u043E\u0447\u0430 \u0431 \u043E\u0434\u043D\u0443 \u0437\u0430\u043A\u0440\u0438\u0454\u043C\u043E.` : mode === "mentor" ? `${tasks.length} \u0437\u0430\u0434\u0430\u0447 \u0456 ${pendingH.length} \u0437\u0432\u0438\u0447\u043E\u043A \u0447\u0435\u043A\u0430\u044E\u0442\u044C. \u0417 \u0447\u043E\u0433\u043E \u043F\u043E\u0447\u043D\u0435\u0448?` : `\u0423 \u0442\u0435\u0431\u0435 ${tasks.length} \u0437\u0430\u0434\u0430\u0447 \u0456 ${pendingH.length} \u0437\u0432\u0438\u0447\u043E\u043A \u043D\u0430 \u0441\u044C\u043E\u0433\u043E\u0434\u043D\u0456. \u0422\u0440\u0438\u043C\u0430\u0454\u0448\u0441\u044F?`;
        ...
        text = mode === "coach" ? `"${first}" \u2014 \u0432\u0441\u0435 \u0449\u0435 \u0432\u0456\u0434\u043A\u0440\u0438\u0442\u0430. \u0417\u0430\u043A\u0440\u0438\u0432\u0430\u0454\u043C\u043E?` : mode === "mentor" ? `\u0417\u0430\u0434\u0430\u0447\u0430 "${first}" \u0447\u0435\u043A\u0430\u0454. \u0404 \u043F\u043B\u0430\u043D?` : `\u0404 \u0437\u0430\u0434\u0430\u0447\u0430 "${first}". \u042F\u043A \u0437 \u043D\u0435\u044E \u0441\u043F\u0440\u0430\u0432\u0438?`;
        chips.push({ label: "\u0417\u0430\u0434\u0430\u0447\u0456", action: "nav", target: "tasks" });
      } else if (pendingH.length > 0) {
        const names = pendingH.slice(0, 2).map((h) => h.name).join(" \u0456 ");
        text = mode === "coach" ? `\u0429\u0435 \u0436\u043E\u0434\u043D\u043E\u0457 \u0437\u0432\u0438\u0447\u043A\u0438 \u0441\u044C\u043E\u0433\u043E\u0434\u043D\u0456. ${names} \u2014 \u0434\u0430\u0432\u0430\u0439 \u0445\u043E\u0447\u0430 \u0431 \u043E\u0434\u043D\u0443.` : mode === "mentor" ? `${names} \u2014 \u0449\u0435 \u043D\u0435 \u0432\u0438\u043A\u043E\u043D\u0430\u043D\u043E. \u0429\u043E \u0437\u0430\u0432\u0430\u0436\u0430\u0454?` : `\u0417\u0430\u043B\u0438\u0448\u0438\u043B\u0438\u0441\u044C ${names}. \u0412\u0441\u0442\u0438\u0433\u043D\u0435\u0448 \u0441\u044C\u043E\u0433\u043E\u0434\u043D\u0456?`;
        chips.push({ label: "\u0417\u0432\u0438\u0447\u043A\u0438", action: "nav", target: "habits" });
...
\u0423\u0442\u043E\u0447\u043D\u0438 \u044F\u043A\u0438\u0439 \u0441\u0430\u043C\u0435, \u0430\u0431\u043E \u0441\u043A\u0430\u0436\u0438 "\u0432\u0456\u0434\u043D\u043E\u0432\u0438\u0442\u0438 \u0432\u0441\u0456".`);
      ...
      saveOffline(text);
      addInboxChatMsg("agent", "\u{1F4DD} \u0417\u0431\u0435\u0440\u0435\u0436\u0435\u043D\u043E \u0432 Inbox. \u0406\u043D\u0442\u0435\u0440\u043D\u0435\u0442 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0438\u0439 \u2014 \u0410\u0433\u0435\u043D\u0442 \u043D\u0435 \u0432\u0438\u0437\u043D\u0430\u0447\u0438\u0432 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u044E. \u041D\u0430\u0434\u0456\u0448\u043B\u0438 \u0449\u0435 \u0440\u0430\u0437 \u043A\u043E\u043B\u0438 \u0431\u0443\u0434\u0435 \u043C\u0435\u0440\u0435\u0436\u0430.");
    }
    aiLoading = false;
    btn.disabled = false;
    btn.innerHTML = SEND_SVG;
